...
import Calendar from './drawer/screen/Calendar';
    ...
    <NavigationContainer>
      <Stack.Navigator initialRouteName='Home'>
        ...
        <Stack.Screen name='Calendar' component={Calendar} options={({ navigation }) => ({
          ...
          headerTitle: "",
          headerLeft: () => (
            <TouchableOpacity activeOpacity={0.6} style={{ backgroundColor: MyColor.primaryColor, borderRadius: 25, padding: 4 }} onPress={() => navigation.goBack()}>
              <Icon name="keyboard-arrow-left" size={26} color={MyColor.white} />
            </TouchableOpacity>
          ),
          headerRight: () => (
            <TouchableOpacity activeOpacity={0.6} style={{ padding: 7, backgroundColor: MyColor.primaryColor, borderRadius: 25 }} onPress={onShare}>
